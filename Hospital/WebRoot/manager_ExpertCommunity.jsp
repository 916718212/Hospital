...
<!-- 判断新增状态 -->
	<%
	String status_add_expertcommunity = (String)session.getAttribute("status_add_expertcommunity");
	if(status_add_expertcommunity==null){
		status_add_expertcommunity = "0";
	}
	//新增成功
	if(status_add_expertcommunity.equals("1")){out.println("<script type=\"text/javascript\">"); 
								  out.println("alert(\"添加成功！\");"); 
								  out.println("</script>");}
	session.setAttribute("status_add_expertcommunity","0"); 
	%>
	<!-- 判断新增状态 -->
	
	<!-- 判断删除状态 -->
	<%
	String status_delete_expertcommunity = (String)session.getAttribute("status_delete_expertcommunity");
	if(status_delete_expertcommunity==null){
		status_delete_expertcommunity = "0";
	}
	//删除成功
	if(status_delete_expertcommunity.equals("1")){out.println("<script type=\"text/javascript\">"); 
								  out.println("alert(\"删除成功！\");"); 
								  out.println("</script>");}
	session.setAttribute("status_delete_expertcommunity","0"); 
	%>
	<!-- 判断删除状态 -->
	
	<!-- 判断更新状态 -->
	<%
	String status_update_expertcommunity = (String)session.getAttribute("status_update_expertcommunity");
	if(status_update_expertcommunity==null){
		status_update_expertcommunity = "0";
	}
	//更新成功
	if(status_update_expertcommunity.equals("1")){out.println("<script type=\"text/javascript\">"); 
								  out.println("alert(\"更新成功！\");"); 
								  out.println("</script>");}
	session.setAttribute("status_update_expertcommunity","0"); 
	%>
	<!-- 判断更新状态 -->
            ...
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code"></span> 专家社区
                    </div>
                    ...
                    <div class="am-g">
								...
								<div class="morph-content">
									<div>
										<div class="content-style-form content-style-form-1">
											...
											<h2>新增</h2>
											<form style="margin-top:-50px;" action="servlet/AddExpertCommunity" method="post">
											<p><label>专家名称</label><input type="text" name="add_name"/></p>
											<p><label>专家图片地址</label><input type="text" name="add_imgsrc"/></p>
											<p><label>专家简介</label><textarea name="add_detail" rows="5" cols="46" style="resize:none;border:2px solid #ebd3bd;background-color:#fef0e3;"></textarea></p>
                        ...
                        <div class="am-u-sm-12 am-u-md-3">
                            <div class="am-input-group am-input-group-sm">
                                <form action="manager_ExpertCommunity.jsp" method="post">
                        ...
                        <div class="tpl-table-images">
							<jsp:useBean id="eCDao" class="dao.ExpertCommunityDao"></jsp:useBean>
							  <%ResultSet rs = null;
								...
								if("".equals(search)){rs = eCDao.getExpertCommunityDao("SELECT * FROM expertcommunity");}
								else{rs = eCDao.getExpertCommunityDao("SELECT * FROM expertcommunity WHERE name LIKE '%"+search+"%'");}
								while(rs.next()){ %>
                            <div class="am-u-sm-12 am-u-md-6 am-u-lg-4">
                                <div class="tpl-table-images-content">
                                    ...
                                    <a href="javascript:;" class="tpl-table-images-content-i">
                                        ...
                                        <img src=<%=rs.getString("imgSrc") %> style="width:310px;height:440px;">
                                    </a>
                                    <div class="tpl-table-images-content-block">
                                        ...
                                        <div class="am-btn-toolbar">
                                            <div class="am-btn-group am-btn-group-xs tpl-edit-content-btn">
													...
													<div class="morph-content">
														<div>
															<div class="content-style-form content-style-form-1">
																<span class="icon icon-close">Close the dialog</span>
																<h2>编辑</h2>
																<form style="margin-top:-50px;" action="servlet/UpdateExpertCommunity" method="post">
																<p><label>专家名称</label><input type="text" name="update_name" value=<%=rs.getString("name") %>></p>
																<p><label>专家图片地址</label><input type="text" name="update_imgsrc" value=<%=rs.getString("imgSrc") %>></p>
																<p><label>专家简介</label><textarea name="update_detail" rows="5" cols="46" style="resize:none;border:2px solid #ebd3bd;background-color:#fef0e3;"><%=rs.getString("detail") %></textarea></p>
																<p><input type="submit" value="保存" style="background-color:E75854;color:white;width:100%;height:55px;margin-top:20px;" /></p>
																</form>
															</div>
														</div>
                                                ...
                                                <a href="servlet/DeleteExpertCommunity?delete_name=<%=rs.getString("name") %>" class="am-btn am-btn-default am-btn-danger" style="margin: 16px 43px;"><span class="am-icon-trash-o"></span> 删除</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
