...
<!-- 判断新增状态 -->
	<%
	String status_add_chinavirus = (String)session.getAttribute("status_add_chinavirus");
	if(status_add_chinavirus==null){
		status_add_chinavirus = "0";
	}
	//新增成功
	if(status_add_chinavirus.equals("1")){out.println("<script type=\"text/javascript\">"); 
								  out.println("alert(\"添加成功！\");"); 
								  out.println("</script>");}
	session.setAttribute("status_add_chinavirus","0"); 
	%>
	<!-- 判断新增状态 -->
	
	<!-- 判断删除状态 -->
	<%
	String status_delete_chinavirus = (String)session.getAttribute("status_delete_chinavirus");
	if(status_delete_chinavirus==null){
		status_delete_chinavirus = "0";
	}
	//删除成功
	if(status_delete_chinavirus.equals("1")){out.println("<script type=\"text/javascript\">"); 
								  out.println("alert(\"删除成功！\");"); 
								  out.println("</script>");}
	session.setAttribute("status_delete_chinavirus","0"); 
	%>
	<!-- 判断删除状态 -->
	
	<!-- 判断更新状态 -->
	<%
	String status_update_chinavirus = (String)session.getAttribute("status_update_chinavirus");
	if(status_update_chinavirus==null){
		status_update_chinavirus = "0";
	}
	//更新成功
	if(status_update_chinavirus.equals("1")){out.println("<script type=\"text/javascript\">"); 
								  out.println("alert(\"更新成功！\");"); 
								  out.println("</script>");}
	session.setAttribute("status_update_chinavirus","0"); 
	%>
	<!-- 判断更新状态 -->
            ...
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code"></span> 新冠事件
                    </div>
                    ...
                    <div class="am-g">
								...
								<div class="morph-content">
									<div>
										<div class="content-style-form content-style-form-1">
											...
											<h2>新增</h2>
											<form style="margin-top:-50px;" action="servlet/AddChinaVirus" method="post">
											<p><label>年份</label><input type="text" name="add_year"/></p>
											<p><label>月日</label><input type="text" name="add_md"/></p>
											<p><label>事件</label><input type="text" name="add_detail"/></p>
                        ...
                        <div class="am-u-sm-12 am-u-md-3">
                            <div class="am-input-group am-input-group-sm">
                                <form action="manager_ChinaVirus.jsp" method="post">
                                ...
                                <table class="am-table am-table-striped am-table-hover table-main">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="table-type">月日</th>
                                            <th class="table-author am-hide-sm-only">事件</th>
                                    ...
                                    <tbody>
										...
										if("".equals(search)){rs = cVDao.getChinaVirus("SELECT * FROM chinavirus");}
										else{rs = cVDao.getChinaVirus("SELECT * FROM chinavirus WHERE detail LIKE '%"+search+"%'");}
										  while(rs.next()){ %>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
															...
															<div class="morph-content">
																<div>
																	<div class="content-style-form content-style-form-1">
																		...
																		<form action="servlet/UpdateChinaVirus?update_time=<%=rs.getString("time") %>" method="post" >
																		<p><label>年份</label><input type="text" name="update_year" value=<%=rs.getString("year") %> /></p>
																		<p><label>月日</label><input type="text" name="update_md" value=<%=rs.getString("md") %> /></p>
																		<p><label>事件</label><input type="text" name="update_detail" value=<%=rs.getString("detail") %> /></p>
																		<p><input type="submit" value="保存" style="background-color:E75854;color:white;width:100%;height:55px;margin-top:20px;" /></p>
																		</form>
																		</div>
																	</div>
                                                        ...
                                                        <a href="servlet/DeleteChinaVirus?delete_time=<%=rs.getString("time") %>" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-trash-o"></span> 删除</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
