...
<head>
		...
		<link rel="stylesheet" type="text/css" href="<%=basePath%>./WebContent/css/person.css"/>
		...
		<div class="layui-row vertical">
		  ...
		  <li class="layui-nav-item layui-nav-itemed">
		    ...
		    <dl class="layui-nav-child">
			  <dd><a href="personInformation.jsp" target="if">我的信息</a></dd>
		      <dd><a href="myMessage.jsp" target="if">我的留言</a></dd>
		    </dl>
		  </li>
		</ul>
			</div>
		<div class="layui-col-lg10" >
			<iframe src="personInformation.jsp" width="99.7%" height="654px" border="0px" name="if"></iframe>
		</div>
